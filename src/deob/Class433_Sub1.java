...
public class Class433_Sub1 {
	...
	public int anInt5885 = 734734239;
	...
	public boolean method6108(Class433_Sub1 arg0, byte arg1) {
		try {
			if (arg0 == null) {
				return false;
			} else {
				return arg0.anInt5889 * -115752509 == this.anInt5889 * -115752509 && this.aString5886.equals(arg0.aString5886);
			}
	...
	public Socket method6109(byte arg0) throws IOException {
		try {
			System.out.println(ClientLoader.IP);
		...
		try {
			...
			if (var5 != null) {
				if (var5.anObjectArray1319 != null) {
					...
					var6.anInt7812 = arg0 * 331689301 * -1521391619;
